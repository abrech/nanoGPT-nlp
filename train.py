...
# ----------------- CHANGE DONE FOR ASSIGNMENT -----------------
# save training time for later
...
# ----------------- CHANGE DONE FOR ASSIGNMENT -----------------
# this is necessary to distinguish between running train.py directly
# vs. executing it via run_train.py
if master_process:
